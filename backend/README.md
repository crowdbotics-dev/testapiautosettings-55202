...
## Project Structure
    ...
    ├── testapiautosettings_55202  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_55202`
...
2. Clone this repo and `cd testapiautosettings_55202`
